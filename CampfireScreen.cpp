...
void CampfireScreen::setupUI() {
    ...
    backgroundLabel->setPixmap(QPixmap(":/assets/campfire/campfire_bg.png").scaled(size(), Qt::KeepAspectRatioByExpanding, Qt::SmoothTransformation));
    ...
    restBtn->setIcon(QIcon(":/assets/campfire/rest_icon.png"));
    ...
    smithBtn->setIcon(QIcon(":/assets/campfire/smith_icon.png"));
    ...
    liftBtn->setIcon(QIcon(":/assets/campfire/lift_icon.png"));
    ...
    restBgLabel->setPixmap(QPixmap(":/assets/campfire/rest_bg.png").scaled(size(), Qt::KeepAspectRatioByExpanding, Qt::SmoothTransformation));
...
void CampfireScreen::resizeEvent(QResizeEvent* event) {
    ...
    backgroundLabel->setGeometry(0, 0, width(), height());
    backgroundLabel->setPixmap(QPixmap(":/assets/campfire/campfire_bg.png").scaled(
    ...
    restBgLabel->setGeometry(0, 0, width(), height());
    restBgLabel->setPixmap(QPixmap(":/assets/campfire/rest_bg.png").scaled(
        size(), Qt::KeepAspectRatioByExpanding, Qt::SmoothTransformation));
